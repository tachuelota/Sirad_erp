<aside class="right-side">
	<section class="content-header">
		<h1>Compra Materiales<small>Registrar</small></h1>
		<ol class="breadcrumb">
			<li>
			...
			<li class="active">Compra Materiales</li>
		</ol>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
						<form id="RegistrarOrdenMaterialesForm" class="form-horizontal" method="post" action-1="<?php echo base_url();?>logistica/ordercompramaterial/registrar">
								<div class="row">
									<div class="col-lg-6">
							...
							<hr>
							<h3>Detalle Compra de Materiales</h3>
							<hr>
